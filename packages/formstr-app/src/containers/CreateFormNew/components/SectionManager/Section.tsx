...
import { Typography, Divider, Card, Button, Space, Modal, Input } from 'antd';
...
const Section: React.FC<SectionProps> = ({
  ...
  const handleDelete = () => {
    Modal.confirm({
      ...
      content: 'Are you sure you want to delete this section? Questions in this section will not be deleted.',
      okText: 'Delete',
      okType: 'danger',
